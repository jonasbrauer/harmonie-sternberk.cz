<template>
  ...
  >
    <div class="has-text-centered text-wrapper">
      <div class="p-5">
...
export default {
  ...
  methods: {
    ...
    setStyle() {
      this.carouselStyle = `background: linear-gradient(#ffffff00 50%, #000), url('${
        this.carousel[this.carouselIndex]
      }') center; background-size: cover; filter: grayscale(0.5)`;
    },
...
.banner {
  ...
  background: linear-gradient(#ffffff00 45%, #222), url("/carousel-1.jpg"),
    center;
